...
const RussianMostCommented = () => {
    ...
    const getMostCommentedPosts = async () => {
        ...
        try {
            ...
            const englishPosts = fetchedPosts.filter(post => post.language === 'ru');
    ...
    return (
        <div className="container mt-5">
            <h2 className="mb-5 fw-bold">Самые комментируемые статьи</h2>
...
export default RussianMostCommented;